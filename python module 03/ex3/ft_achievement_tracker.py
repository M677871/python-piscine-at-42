...
def calculate_unique_achievements(
    alice: Set[str],
    bob: Set[str],
    charlie: Set[str],
) -> Set[str]:
...
def calculate_common_achievements(
    alice: Set[str],
    bob: Set[str],
    charlie: Set[str],
) -> Set[str]:
...
def calculate_rare_achievements(
    alice: Set[str],
    bob: Set[str],
    charlie: Set[str],
) -> Set[str]:
...
def print_achievement_analytics(
    alice: Set[str],
    bob: Set[str],
    charlie: Set[str],
) -> None:
    ...
    unique_achievements: Set[str] = calculate_unique_achievements(
        alice, bob, charlie
    )
    print(f"All unique achievements: {unique_achievements}")
    print(f"Total unique achievements: {len(unique_achievements)}")

    common_achievements: Set[str] = calculate_common_achievements(
        alice, bob, charlie
    )
    print(f"Common to all players: {common_achievements}")

    rare_achievements: Set[str] = calculate_rare_achievements(
        alice, bob, charlie
    )
    ...
    print(
        "Charlie unique: "
        f"{charlie.difference(alice.union(bob))}"
    )
